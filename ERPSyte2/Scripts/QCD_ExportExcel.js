...
function ExportToExcelClientA(pShowCooperate, pShowBuy,
    pDateTransferFrom, pDateTransferTo, pDateAcceptFrom, pDateAcceptTo,
    pDateTransferFrom2, pDateTransferTo2, pDateAcceptFrom2, pDateAcceptTo2,
    pItem, pDescription, pRepeated, pTemaNIOKR, pVend, pVendN, pChecker, pScrap, pLot,
    pWaitWork, pWaitANP, pWaitWorkDay, pWaitANPDay, pShowOnlyLocQCD, pShowOnlyLocWork, pUM,
    pShowRecordset_primary, pShowRecordset_secondary, pShowRecordset_details, pShowRecordset_vendors
    ) {
    //каталог временных файлов
    var temp_folder = "";
    var oWshShell = new ActiveXObject("WScript.Shell");
