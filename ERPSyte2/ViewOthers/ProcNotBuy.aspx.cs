...
{
    public partial class ProcNotBuy : System.Web.UI.Page
    {
        ...
        private void BindDummyRow()
        {
            ...
            dummy.Columns.Add("Item");
            dummy.Columns.Add("Description");
            dummy.Columns.Add("DateCode004");
            dummy.Columns.Add("IsAnalogRegistered");
            dummy.Columns.Add("IsAnalogApproved");
            dummy.Columns.Add("IsEquivalentPush");
            dummy.Columns.Add("IsVersionAdvance");
            dummy.Columns.Add("IsApplyClosed");
            dummy.Columns.Add("IsLeadTime999");
            dummy.Rows.Add();
            GridViewData.Columns[5].Visible = true;
            GridViewData.Columns[6].Visible = !this.GridViewData.Columns[5].Visible;
            GridViewData.Columns[7].Visible = true;
            GridViewData.Columns[8].Visible = !this.GridViewData.Columns[7].Visible;
            GridViewData.DataSource = dummy;
        ...
        private void DoApplyFilter(SqlConnection Acon)
        {
            ...
            try
            {
                ...
                {
                    dAccessRight = (int)dtViewerData.Rows[0]["AccessRight"];
                }
                bool EquivalentPush_Grant = (dAccessRight & 32) == 32; //ProcessNotBuy. Начальник КБ (или лицо его заменяющее). dbo.zKd_UserRight
                bool VersionAdvance_Grant = (dAccessRight & 32) == 32; //ProcessNotBuy. Начальник КБ (или лицо его заменяющее). dbo.zKd_UserRight

                GridViewData.Columns[5].Visible = !EquivalentPush_Grant;
                GridViewData.Columns[6].Visible = EquivalentPush_Grant;
                GridViewData.Columns[7].Visible = !VersionAdvance_Grant;
                GridViewData.Columns[8].Visible = VersionAdvance_Grant;
